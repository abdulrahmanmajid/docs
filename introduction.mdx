...
<div className="relative">
  ...
  <div className="px-4 py-16 lg:py-48 lg:pb-24 max-w-3xl mx-auto">
    ...
    <div className="px-6 lg:px-0 mt-12 lg:mt-24 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="rocket" title="Introduction & Demo" description="Deploy your first AI Voice Agent in minutes with our step-by-step guide" href="/quickstart" />

      <HeroCard
        filename="cli"
        title="API-Reference"
        description="Integrate Kallabot AI using our APIs in your applications and workflows"
        href="/installation"
      />
      ...
      <HeroCard
        ...
        description="Build Custom workflows to automate your business and supercharge your Voice Agent"
        href="/editor"
      />
      ...
      <HeroCard
        filename="components"
        title="Tutorials"
        description="Build Workflows and Agents with our ready-to-use tutorials"
        href="/text"
      />
    </div>
  </div>
